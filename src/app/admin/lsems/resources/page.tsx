...
export default function LSEMSResourcesValuesPage() {
    const { userProfile, loading } = useAuth();
    // Permission Check
    const hasAccess = userProfile?.roles?.some(r => ['admin', 'lsems'].includes(r));
    ...
    return <FactionResourcesEditor faction="LSEMS" pageTitle="LSEMS Resources" />;
}
