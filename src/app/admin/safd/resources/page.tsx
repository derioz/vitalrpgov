...
export default function SAFDResourcesValuesPage() {
    const { userProfile, loading } = useAuth();
    // Permission Check
    const hasAccess = userProfile?.roles?.some(r => ['admin', 'safd'].includes(r));
    ...
    return <FactionResourcesEditor faction="SAFD" pageTitle="SAFD Resources" />;
}
